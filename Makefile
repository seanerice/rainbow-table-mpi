all:
	/usr/local/mpich-3.2/bin/mpicc -I. -Wall source/crackpass.cpp source/salty.cpp source/SubstringIterator.cpp source/pwdhashiter.cpp -g -lstdc++ -std=c++11 -o crackpass
